...
import img1  from '../assets/puu.png';
...
export default function Sass() {
  return (
    ...
    <h5>상대 경로로 불러오기</h5>
    <img src="../assets/puu.png" alt="src내부에 이미지가 있을 때는 경로명으로 접근할 수 없습니다."/>
    ...
    <h5>img 태그 사용하기</h5>
    <img src="/assets/puu.png" alt="경로명으로 접근가능, public 폴더는 static폴더이기 때문에 /로 접근"/>
    <img src={process.env.PUBLIC_URL+"/assets/puu.png" } alt=""/>
    <h5>css파일에서 이미지 접근(background-image 속성)</h5>
