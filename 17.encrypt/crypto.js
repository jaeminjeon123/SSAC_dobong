...
function decrypt(encryptedText) {
    ...
    //2. 실제 데이터 복호화
    //base64를 인코딩된 문자열이 utf8형태로 복호화된다.
...
const encryptedMesaage=encrypt(originalMessage);
console.log('암호화 됨',encryptedMesaage);

const decryptedMessage=decrypt(encryptedMesaage);
console.log("복호화됨",decryptedMessage)